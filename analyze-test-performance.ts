...
export class TestPerformanceAnalyzer {
  ...
  public async analyzePerformance(): Promise<PerformanceReport> {
    ...
    const testFiles = [
      ...
      { name: '虚拟滚动覆盖率测试', path: '__tests__/components/ui/virtual-scroll-coverage.test.tsx' },
      { name: '数据分片加载测试', path: '__tests__/lib/utils/chunked-data-loader.test.ts' },
      { name: '数据预加载测试', path: '__tests__/lib/utils/data-preloader.test.ts' },
      { name: '拖拽排序功能测试', path: '__tests__/lib/utils/drag-drop.test.ts' },
      { name: '拖拽排序覆盖率测试', path: '__tests__/lib/utils/drag-drop-coverage.test.ts' },
      { name: '快捷键功能测试', path: '__tests__/lib/utils/keyboard-shortcuts.test.ts' },
      { name: '离线支持功能测试', path: '__tests__/lib/utils/offline-support.test.ts' },
      { name: '真实用户场景测试', path: '__tests__/e2e/real-user-scenarios.test.ts' },
      { name: '数据驱动测试', path: '__tests__/data-driven/data-driven-tests.test.ts' },
    ];
